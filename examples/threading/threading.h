...
struct thread_data {
    ...
    int wait_to_obtain_ms;          // how long to wait before locking the mutex (milliseconds)
    int wait_to_release_ms;         // how long to hold the mutex before unlocking (milliseconds)
    bool thread_complete_success;   // success flag for thread completion
};
