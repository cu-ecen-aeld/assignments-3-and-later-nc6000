...
int Test_validate_username_main(void)
{
  UnityBegin("/home/nc6000/cu/001/assignment-1-nc6000/assignment-autotest/../student-test/assignment1/Test_validate_username.c");
  run_test(test_validate_my_username, "test_validate_my_username", 17);
